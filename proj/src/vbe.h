...
#define ACCESS_VBE 				0x10
#define VBE_SET_MODE 			0x4F02
#define VBE_RETURN_MODE 		0x4F01
#define VBE_RETURN_CONTROLLER	0x4F00

/*---------------------VBE CONTROLLER CAPABILITIES BITS-------------------*/
#define DAC_SWITCHABLE		BIT(0)
#define VGA_INCOMPATIBLE	BIT(1)
#define NOT_NORMAL_RAMDAC	BIT(2)
#define VIDEO_MODE_END		-1
